  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black italic uppercase tracking-tighter text-white">Command Center</h1>
      ...
      <div className="bg-[#0f172a] p-10 rounded-[3rem] border border-white/10 shadow-sm relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="flex flex-col items-end">
              <span className="text-[10px] font-black bg-[#1e293b] px-4 py-2 rounded-xl uppercase text-slate-300 mb-1 border border-white/10">Game ID: {flyovaResult.gameId}</span>
